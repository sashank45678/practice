...
const About = () => {
    ...
    const {changetheme}=userinfo
    return (
        <div className="flex flex-col items-center justify-center border border-black rounded-lg my-4 px-3 py-3" style={{backgroundColor:color}}>
            ...
            <button className='px-2 py-2 rounded-md bg-black text-white' onClick={()=>{changetheme()}}>changeTheme</button>
        </div>
    );
};
